          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 items-start">
            ...
            <div className="flex flex-col items-center gap-8 lg:order-1 order-first">
              ...
              <div className="flex gap-4">
                ...
                <SocialLink href="https://www.linkedin.com/in/bvanhuy2706/" label="LinkedIn">
                  <Linkedin size={20} />
                </SocialLink>
                <SocialLink href="https://www.facebook.com/bui.van.huy.757044/" label="Facebook">
                  <Facebook size={20} />
                </SocialLink>
                <SocialLink href="https://www.instagram.com/buivanhuy333/" label="Instagram">
                  <Instagram size={20} />
                </SocialLink>
        ...
        <div className="container">
              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-text-light font-medium mb-3">
                      {item.subtitle}
                    </p>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  title: t("about.interest1Title"),
                  desc: t("about.interest1Desc"),
                },
                {
                  title: t("about.interest2Title"),
                  desc: t("about.interest2Desc"),
                },
                {
                  title: t("about.interest3Title"),
                  desc: t("about.interest3Desc"),
                },
              ].map((item, index) => (
                <div
                  key={index}
          ...
          <div>
            ...
            <div className="bg-card rounded-2xl p-8 shadow-lg shadow-shadow flex flex-col gap-6">
              ...
              <p className="text-text leading-relaxed">
                {t("about.goalsParagraph2")}
              </p>
              <p className="text-text leading-relaxed">
                {t("about.goalsParagraph3")}
              </p>
            </div>
          </div>
        </div>
